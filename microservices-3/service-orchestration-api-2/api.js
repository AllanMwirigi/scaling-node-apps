...
/**
 * Service orchestration using an API layer i.e. a middleman which manages requests to multiple services 
 */
...
const app = express()
    ...
    .post('/reserve', async (req, res) => {
        // reserving a show involves both services
        ...
        // Lookup the Show using the show service
...
// all requests are through this port. required/additional data can be obtained from the other services as needed